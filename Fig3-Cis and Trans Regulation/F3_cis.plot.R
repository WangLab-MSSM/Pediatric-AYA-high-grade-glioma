library(openxlsx)
# read data ################################
df.all = readRDS('../data/pediatric_aya_hgg_study_data.rds')

mut = df.all$mutation$data

rna = df.all$rna$data

cnv = df.all$cnv$data
g.cnv = df.all$cnv$anno$ApprovedGeneSymbol

protein = df.all$protein$data
g.protein = df.all$protein$anno$ApprovedGeneSymbol

clinical = df.all$clinical
...
t.test(pro~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GUCY1B1'&age.cat2=='Ped'))[[3]]
t.test(pro~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GUCY1B1'&age.cat2=='AYA'))[[3]]
t.test(pro~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GUCY1B1'&age.cat2=='Adult'))[[3]]

t.test(pro~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GOLGA2'&age.cat2=='Ped'))[[3]]
t.test(pro~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GOLGA2'&age.cat2=='AYA'))[[3]]
t.test(pro~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GOLGA2'&age.cat2=='Adult'))[[3]]

t.test(rna~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GOLGA2'&age.cat2=='Ped'))[[3]]
t.test(rna~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GOLGA2'&age.cat2=='AYA'))[[3]]
t.test(rna~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GOLGA2'&age.cat2=='Adult'))[[3]]

t.test(rna~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GUCY1B1'&age.cat2=='Ped'))[[3]]
t.test(rna~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GUCY1B1'&age.cat2=='AYA'))[[3]]
t.test(rna~cnv.category,data = dplyr::filter(df.cnv.plot.main,gene == 'GUCY1B1'&age.cat2=='Adult'))[[3]]
...
# df.KS.all2 = readRDS('~/Dropbox/HOPE_iProFun/github/df.KS.all_old.rds')
# mean(df.KS.all[match(paste(df.KS.all2$gene,df.KS.all2$subtype),paste(df.KS.all$gene,df.KS.all$subtype)),]==df.KS.all2)
...
pdf('~/Dropbox/HOPE_iProFun/github/iProFun_cnv_circle_S3.pdf',height = 10,width = 10)
par(mar = c(0,0,0,0))
