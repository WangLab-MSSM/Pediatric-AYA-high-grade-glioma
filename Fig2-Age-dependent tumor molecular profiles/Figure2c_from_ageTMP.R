...
# Reproduce a Figure 2C-style normal/tumor trajectory panel from ageTMP.
#
# Inputs:
# - Tumor protein matrix: data/cDisc_proteome_imputed_data_09152023.tsv
# - Clinical metadata: data/clinical_data_04032026.tsv
# - Normal reference data: ageTMP package extdata normal_reference.rds
#
# Output:
# - figure2c_from_ageTMP.pdf
# - figure2c_from_ageTMP.png

required_packages <- c("ageTMP", "ggplot2")
...
output_pdf <- "figure2c_from_ageTMP.pdf"
output_png <- "figure2c_from_ageTMP.png"
